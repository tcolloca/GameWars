...
export class PiouPiou {
    ...
    preload() {
      this.game.load.atlasJSONHash('player', '../../assets/sprites/player/player.png', '../../assets/sprites/player/player.json');
      this.game.load.image('background', '../../assets/sprites/piou-piou/background.png');
      this.game.load.image('mushroom', '../..//assets/sprites/piou-piou/mushroom.png');
      this.game.load.image('block', '../../assets/sprites/piou-piou/block.png');
      this.game.load.image('coin', '../../assets/sprites/piou-piou/coin.png');
      this.game.load.image('button', '../../assets/button.png');

      this.game.load.audio('coin-drop', '../../assets/audio/piou-piou/coin-drop.mp3');
      this.game.load.audio('pickup', '../../assets/audio/piou-piou/pickup.mp3');
      this.game.load.audio('coin-break', '../../assets/audio/piou-piou/coin-break.wav');
      this.game.load.audio('gameover', '../../assets/audio/piou-piou/gameover.wav');
      this.game.load.audio('gamestart', '../../assets/audio/piou-piou/gamestart.mp3');
    }
