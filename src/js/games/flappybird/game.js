...
(function (FlappyBird_1) {
    class FlappyBird {
        ...
        startPreload() {
            ...
            this.game.load.image('top_pipe', '../../assets/sprites/flappybird/top_pipe.png');
            this.game.load.image('bottom_pipe', '../../assets/sprites/flappybird/bottom_pipe.png');
            this.game.load.image('background', '../../assets/sprites/flappybird/background.png');
            this.game.load.image('button', '../../assets/button.png');
            this.game.load.audio('jump', '../../assets/audio/flappybird/jump.wav');
            this.game.load.audio('death', '../../assets/audio/flappybird/cuek.swf.mp3');
