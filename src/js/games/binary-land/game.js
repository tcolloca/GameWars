...
(function (BinaryLand) {
    ...
    class binaryLand {
        ...
        preload() {
            this.game.load.image('wall', '../../assets/sprites/binary-land/block.png');
            this.game.load.image('goal', '../../assets/sprites/binary-land/goal.png');
            this.game.load.image('heart', '../../assets/sprites/binary-land/heart.png');
            this.game.load.image('shotTop', '../../assets/sprites/binary-land/attack_top.png');
            this.game.load.image('shotDown', '../../assets/sprites/binary-land/attack_bottom.png');
            this.game.load.image('shotLeft', '../../assets/sprites/binary-land/attack_left.png');
            this.game.load.image('shotRight', '../../assets/sprites/binary-land/attack_right.png');
            this.game.load.atlasJSONHash('player2', '../../assets/sprites/player/player2.png', '../../assets/sprites/player/player.json');
            this.game.load.atlasJSONHash('player1', '../../assets/sprites/player/player.png', '../../assets/sprites/player/player.json');
            this.game.load.atlasJSONHash('boo', '../../assets/sprites/binary-land/boo.png', '../../assets/sprites/binary-land/boo.json');
        }
        create() {
            this.internalWalls = [];
            this.limitWalls = [];
